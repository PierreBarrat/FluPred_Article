...
Interference between multiple such advantages mutations will perturb the trajectories \citep{illingworth_components_2012} but we still expect a consistent tendency to rise in frequency (see below).
...
In supplementary figure \ref{fig:pfix_v_freq_combijohnsmodels}, we repeat this analysis for several predictors from our recent comparison of predictive models for influenza \citep{huddleston_integrating_2020} including models that use serological data.
