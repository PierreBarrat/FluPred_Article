...
%DIF DEL /dev/fd/63    Thu Nov 19 18:44:44 2020
%DIF ADD article.tex   Thu Nov 19 18:10:24 2020
...
\subsection{\DIFadd{Correcting for nested mutations}} %DIF >  (fold)
\label{sub:correcting_for_nested_mutations}
...
\begin{figure}
	...
	\caption{\textbf{\DIFaddFL{Top}}\DIFaddFL{: Left-axis: number $n$ of clusters as a function of the threshold distance $d^\star$. The total number of trajectories is shown as a flat orange line. Right-axis: average size of clusters as a function of $d^\star$. }\textbf{\DIFaddFL{Bottom}}\DIFaddFL{: Examples of clusters for four values of $d^\star$. The four clusters displayed are the ones to which mutation HA1:33R belongs to. }}
