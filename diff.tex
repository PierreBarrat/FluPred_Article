...
%DIF DEL /dev/fd/63    Tue Dec 15 11:14:35 2020
%DIF ADD article.tex   Tue Dec 15 10:50:56 2020
...
but we still expect a consistent tendency to rise in frequency (see below).
}\DIFaddend 
...
\DIFdelbegin \DIFdel{Two ways of categorising mutations, however, suggest some power to predict }\DIFdelend \DIFaddbegin \DIFadd{In supplementary figure \sref{fig:pfix_v_freq_combijohnsmodels}, we repeat this analysis for several predictors from our recent comparison of predictive models for influenza \mbox{%DIFAUXCMD
\citep{huddleston_integrating_2020} }\hspace{0pt}%DIFAUXCMD
including models that use serological data.
