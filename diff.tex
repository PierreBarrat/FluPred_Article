...
%DIF DEL /dev/fd/63    Wed Dec 16 12:07:05 2020
%DIF ADD article.tex   Wed Dec 16 12:04:54 2020
...
In classic models of population genetics, strongly advantageous variants undergo rapid selective \emph{sweeps}, i.e., the rapid rise and \DIFdelbegin \DIFdel{fixation}\DIFdelend \DIFaddbegin \DIFadd{fix}\DIFaddend .
...
but we still expect an average }\pierre{replaced ``consistent'' by ``average''} \DIFadd{tendency to rise in frequency (see below). }\pierre{Is this ``see below'' necessary? I think that's what the reader naturally does! }
\DIFaddend 
