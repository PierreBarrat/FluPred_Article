...
%DIF DEL /dev/fd/63    Fri Dec 11 18:15:46 2020
%DIF ADD article.tex   Fri Dec 11 18:12:12 2020
...
\label{sec:introduction}
	...
	\DIFaddbegin \DIFadd{A mutation with a fitness benefit should have a tendency to fix, while detrimental mutations fix less often.
...
, who showed that intrinsic selection, background fitness, and later interference have comparable effects on fixation.
	%DIF >  Need more context/bridging
	}\DIFaddend In this work, we use HA and NA sequences of A/H3N2 and A/H1N1pdm influenza from year 2000 to 2019 to perform a retrospective analysis of frequency trajectories of amino acid mutations.
...
\DIFaddbegin \DIFadd{Since genomic segments of influenza do not recombine, concurrent trajectories of mutations on the same segment will be correlated.
...
While the number of trajectories that contribute to the analysis decreases with more aggressive clustering, this does not significantly change the results presented below.
}

\DIFaddend In the rest of this work, we will focus on frequency trajectories that are starting at a zero (low) frequency, \emph{i.e.} $f(t=0)=0$.
